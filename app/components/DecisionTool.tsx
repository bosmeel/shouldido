  ...
  function getResult(): ResultType {
    ...
    if (isDoubleText) {
      return {
        ...
        sub: "You’re sending another message too quickly.",
      };
    }
    ...
    if (isChasing) {
      return {
        label: "DON’T TEXT",
        color: "text-red-600",
        msg: "You’re chasing. Stop.",
        sub: "Let them come back to you.",
      };
    }
    ...
    if (theyPulledAway) {
      return {
        ...
        msg: "They pulled back. Wait.",
        sub: "Give them space to re-engage.",
      };
    }
    ...
    if (score >= 3) {
      return {
        ...
        sub: "The situation is balanced and you're not chasing.",
      };
    }
    ...
    if (score <= -3) {
      return {
        ...
        sub: "You risk lowering your position by reaching out.",
      };
    }
    ...
    return {
      ...
      sub: "Waiting increases your chances of a better response.",
    };
  }
    ...
    <section className="space-y-6">
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2">
          <ChoiceButton value="Me" selected={last==="me"} onClick={()=>setLast("me")} />
          <ChoiceButton value="Them" selected={last==="them"} onClick={()=>setLast("them")} />
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2">
          <ChoiceButton value="<1h" selected={time==="<1h"} onClick={()=>setTime("<1h")} />
          <ChoiceButton value="Hours" selected={time==="hours"} onClick={()=>setTime("hours")} />
          <ChoiceButton value="1 day" selected={time==="1d"} onClick={()=>setTime("1d")} />
          <ChoiceButton value="2–3 days" selected={time==="2-3d"} onClick={()=>setTime("2-3d")} />
          <ChoiceButton value="4+ days" selected={time==="4d"} onClick={()=>setTime("4d")} />
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2">
          <ChoiceButton value="Good" selected={vibe==="good"} onClick={()=>setVibe("good")} />
          <ChoiceButton value="Mixed" selected={vibe==="mixed"} onClick={()=>setVibe("mixed")} />
          <ChoiceButton value="Bad" selected={vibe==="bad"} onClick={()=>setVibe("bad")} />
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2">
          <ChoiceButton value="Miss them" selected={intent==="miss"} onClick={()=>setIntent("miss")} />
          <ChoiceButton value="Need something" selected={intent==="need"} onClick={()=>setIntent("need")} />
          <ChoiceButton value="Check in" selected={intent==="check"} onClick={()=>setIntent("check")} />
          <ChoiceButton value="Emotional" selected={intent==="emotional"} onClick={()=>setIntent("emotional")} />
        </div>
      </div>
